...
header {
	background:url(https://dm0qx8t0i9gc9.cloudfront.net/thumbnails/video/HjH5lgeHeix7kfhup/videoblocks-good-friends-is-resting-and-talking-at-a-table-in-a-cafe_hz3w6wm6m_thumbnail-1080_01.png);
	height: 80vh;
...
"https://play-zelo-production.s3.ap-south-1.amazonaws.com/uploads/center_caption_photo/photo/5dc5b46109ba996c9832c6dc/1.jpg"
  ...
  <div class = "intro">
  <h1>FAQ's</h1>
  <li>Password Queries</li>
  <p>Q.I forgot password? How can I get it?<br/> No need to worry if you forget your password.<br/><strong>Hosteldekho</strong> will send your password on your registered Email-Id</p> 
  <li>Booking Queries</li>
<p>Q.How do I make a booking?<br/> Making a booking through <strong>Hosteldekho</strong> is easy!
<br/>Once you have selected your desired hostel ,you have just select the room type and check in date and click on submit and further click on book button.</p>
	  <li>Account Queries</li>
	  <p>Q.How can I login to my account?<br/>If you haven't registered yet on our website, you need to first and then by clicking on Sign in button you can fill your registered email and password and login into your account.</p>
	  
	  <li>Cancel booking Queries</li>
	  <p>Q.How do I cancel my booking?<br/>Sorry.We don't have that facility on our website.</p>
	  </ul>
	</div>
	<h4 class="query">For more queries ,mail us on </h4><a class="mail" href =" mailto:hosteldekho20@gmail.com" style="color:black;font-size:20px;"><img src="https://1000logos.net/wp-content/uploads/2021/05/Gmail-logo.png" height="50" width="50"/></a>
    </aside>
  <br/>
  <br/>
   <footer>
